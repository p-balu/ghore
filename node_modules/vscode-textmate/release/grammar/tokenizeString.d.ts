...
declare class TokenizeStringResult {
    ...
    constructor(stack: StateStackImpl, stoppedEarly: boolean);
}
/**
 * Tokenize a string
 * @param grammar
 ...
 */
export declare function _tokenizeString(grammar: Grammar, lineText: OnigString, isFirstLine: boolean, linePos: number, stack: StateStackImpl, lineTokens: LineTokens, checkWhileConditions: boolean, timeLimit: number): TokenizeStringResult;
